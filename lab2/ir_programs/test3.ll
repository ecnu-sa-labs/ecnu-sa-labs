...
entry:
  ...
  store i32 2, ptr %b, align 4, !dbg !19
  tail call void @llvm.dbg.declare(metadata ptr %c, metadata !20, metadata !DIExpression()), !dbg !21
  %0 = load i32, ptr %a, align 4, !dbg !22
  %cmp = icmp sgt i32 %0, 100, !dbg !24
  br i1 %cmp, label %if.then, label %if.end, !dbg !25

if.then:                                          ; preds = %entry
  tail call void @llvm.dbg.declare(metadata ptr %d, metadata !26, metadata !DIExpression()), !dbg !28
  %1 = load i32, ptr %a, align 4, !dbg !29
  %2 = load i32, ptr %b, align 4, !dbg !30
  %div = sdiv i32 %1, %2, !dbg !31
  store i32 %div, ptr %d, align 4, !dbg !28
...
!1 = !DIFile(filename: "test3.c", directory: "/lab2/c_programs", checksumkind: CSK_MD5, checksum: "c26dbe33367b5a21ba23429a983cc444")
...
!26 = !DILocalVariable(name: "d", scope: !27, file: !1, line: 8, type: !13)
!27 = distinct !DILexicalBlock(scope: !23, file: !1, line: 7, column: 16)
!28 = !DILocation(line: 8, column: 9, scope: !27)
!29 = !DILocation(line: 8, column: 13, scope: !27)
!30 = !DILocation(line: 8, column: 17, scope: !27)
!31 = !DILocation(line: 8, column: 15, scope: !27)
